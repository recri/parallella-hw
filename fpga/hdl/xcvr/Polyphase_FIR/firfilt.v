...
module fir256(
	      ...
	      input signed [MBITS-1:0] 	x_imag,
	      output signed [ABITS-1:0] Raccum_out,
	      output signed [ABITS-1:0] Iaccum_out
	);
   ...
   reg signed [ABITS-1:0] Raccum;
   reg signed [ABITS-1:0] Iaccum;

   assign q_real = reg_q[MBITS*2-1:MBITS];
   assign q_imag = reg_q[MBITS-1:0];
   assign Raccum_out = Raccum;
   assign Iaccum_out = Iaccum;
